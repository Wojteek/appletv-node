    ...
    */
    ...
    completePairing(pin) {
        ...
        return this.device
            ...
            const { secretKey, publicKey } = ed25519_supercop_1.createKeyPair(seed);
            ...
            const deviceSignature = ed25519_supercop_1.sign(deviceInfo, publicKey, secretKey);
